...
import com.bbbbiu.biu.httpd.upload.exceptions.FileUploadIOException;
import com.bbbbiu.biu.httpd.upload.interfaces.FileItemStream;
import com.bbbbiu.biu.httpd.upload.interfaces.ProgressListener;
...
public class MultipartStream {
    ...
    public int readBodyData(OutputStream output) throws IOException {
        ...
        return (int) Streams.copy(inputStream, output, false);
    }
