...
public class MultipartStream {
    ...
    public boolean readBoundary()
            throws FileUpload.FileUploadIOException, MalformedStreamException {
        ...
        } catch (FileUpload.FileUploadIOException e) {
     ...
     */
    public String readHeaders() throws FileUpload.FileUploadIOException, MalformedStreamException {
        int i = 0;
        byte b;
