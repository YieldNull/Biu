...
public class DiskScanService extends IntentService {
            ...
            if (intent != null) {
                ...
                if (action != null) {
                    if (action.equals(Intent.ACTION_BOOT_COMPLETED)) {
                        ...
                        DiskScanService.startScan(context);// 启动服务，接收Alarm或者Boot BroadCast
    ...
    public static PendingIntent createPendingIntent(Context context) {
        Intent intent = new Intent(context, DiskScanService.ScanAlarmReceiver.class);
