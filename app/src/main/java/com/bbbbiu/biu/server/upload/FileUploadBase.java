...
import com.bbbbiu.biu.server.upload.util.Closeable;
import com.bbbbiu.biu.server.upload.util.FileItemHeadersImpl;
import com.bbbbiu.biu.server.upload.util.LimitedInputStream;
import com.bbbbiu.biu.server.upload.util.Streams;
...
public abstract class FileUploadBase {
    ...
    public static boolean isMultipartContent(HttpRequest request) {
        return HttpdFileUpload.isMultipartContent(request);
    }
     ...
     */
    @Deprecated
    public List<FileItem> parseRequest(HttpRequest session)
            throws FileUploadException {
        return parseRequest(new RequestContext(session));
    }
    ...
    private class FileItemIteratorImpl implements FileItemIterator {
        ...
        FileItemIteratorImpl(RequestContext ctx)
            ...
            final long requestSize = RequestContext.class.isAssignableFrom(ctx.getClass())
                    ...
                    ? ((RequestContext) ctx).contentLength()
                    : contentLengthInt;
            // CHECKSTYLE:ON
